...
sedi "/gitpod/ s|tokenize-technology/dex-contracts|"${GITHUB_REPOSITORY}"|;" "README.md"
sedi "/gitpod-badge/ s|tokenize-technology/dex-contracts|"${GITHUB_REPOSITORY}"|;" "README.md"
sedi "/gha/ s|tokenize-technology/dex-contracts|"${GITHUB_REPOSITORY}"|;" "README.md"
sedi "/gha-badge/ s|tokenize-technology/dex-contracts|"${GITHUB_REPOSITORY}"|;" "README.md"
